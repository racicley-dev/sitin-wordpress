...
<section section class="destaque">
    ...
    <section class="resultado">
      <div class="largura-site">
        <div class="resultado__container">
          <img width="134" height="145" class="resultado__imagem-grande" src="<? echo IMAGES_DIR ?>/foguetinho.png"
        ...
        <div class="solucoes__container">
          <article>
            <div class="solucoes__container__titulo-imagem">
              <img class="solucoes__imagem" src="<? echo IMAGES_DIR ?>/sistemas-pequeno.svg"
          ...
          <article>
            <div class="solucoes__container__titulo-imagem">
              <img class="solucoes__imagem" src="<? echo IMAGES_DIR ?>/sites-pequeno.svg"
          ...
          <article>
            <div class="solucoes__container__titulo-imagem">
              <img class="solucoes__imagem" src="<? echo IMAGES_DIR ?>/aplicativos-pequeno.svg" alt="Imagem de um aplicativo">
              <h4>Aplicativos</h4>
            </div>
            <div class="solucoes__caixa">
        ...
        <div class="slide-clientes">
          ...
          <div class="content-wrapper swiper-wrapper">
            <div class="card swiper-slide">
              <img class="" src="<? echo IMAGES_DIR ?>/coca-cola.svg" alt="...">
            </div>
            <div class="card swiper-slide>
              <img class="" src="<? echo IMAGES_DIR ?>/afac.svg" alt="Logo da AFAC">
            </div>
            <div class="card swiper-slide">
              <img class="" src="<? echo IMAGES_DIR ?>/sabendo-mais.svg" alt="Logo da empresa Sabendo Mais">
            </div>
            <div class="card swiper-slide">
              <img class="" src="<? echo IMAGES_DIR ?>/fiocruz.svg" alt="Logo da empresa Sabendo Mais">
            </div>
    ...
    <section class="orcamento">
      <div class="orcamento__container largura-site">
        <img src="<? echo IMAGES_DIR ?>/mao-pequena.svg" alt="Imagem de duas mãos se tocando">
